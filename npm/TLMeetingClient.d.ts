...
export declare class MeetingClient {
    ...
    onJoinedRoom: (roomInfo: typeof MeetingClient.roomInfo) => void;
    onLeavedRoom: (roomInfo: typeof MeetingClient.roomInfo) => void;
    ...
    join(roomId: string, extraData: any, isVideo?: boolean, isAudio?: boolean, cameraId?: string): Promise<{
        success: boolean;
        msg?: string;
    }>;
